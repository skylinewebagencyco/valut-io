  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-12 h-12 bg-[#5A5A40] hover:bg-[#4A4A32] transition-all rounded-2xl flex items-center justify-center text-white font-serif text-2xl shadow-sm cursor-pointer group"
      >
        <span>V</span>
      </button>
